...
function Scene({
  ...
  return (
    <>
      ...
      <ParticleField count={isMobile ? 300 : 800} mousePos={mousePos} />

      {!isMobile && <LaptopModel mousePos={mousePos} />}

      <PhoneModel
        mousePos={mousePos}
        position={isMobile ? [0, 0, 0] : [2.4, 0.3, 0]}
  ...
  return (
    ...
    >
      ...
      <Canvas
        ...
        style={{ width: '100%', height: isMobile ? '100vw' : '100vh' }}
        dpr={[1, 2]}
      >
